...
public class crapss {
    ...
    // ---- lance les deux dés et renvoie la somme ----
    public static int lance_dee() {
        Random generateur = new Random();
        int dee_un = generateur.nextInt(1, 7);   // 1 à 6
        int dee_deux = generateur.nextInt(1, 7); // 1 à 6

        System.out.println("dé_un a fait : " + dee_un);
        System.out.println("dé_deux a fait : " + dee_deux);

        return dee_un + dee_deux; // somme entre 2 et 12
    }
